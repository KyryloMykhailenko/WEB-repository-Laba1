...
const dev1 = new Developer("Олександр", "Шевченко", 1000, 3);
const dev2 = new Developer("Наталія", "Коваленко", 1200, 6);
const des1 = new Designer("Віталій", "Бондаренко", 1100, 4, 0.9);
const des2 = new Designer("Ірина", "Ткаченко", 1300, 7, 0.95);

const manager1 = new Manager("Дмитро", "Кравчук", 1500, 8, [dev1, des1]);
const manager2 = new Manager("Олена", "Мельниченко", 1600, 10, [dev2, des2, dev1, dev2, des1, des2, dev1, dev2, des1, des2]);
